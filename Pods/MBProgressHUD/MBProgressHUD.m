...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.mode = MBProgressHUDModeIndeterminate; // change here
        self.labelText = @"Loading";
        self.detailsLabelText = @"Please wait";
        self.opacity = 0.8f;
        self.color = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.9]; // here
